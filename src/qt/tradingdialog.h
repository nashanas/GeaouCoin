...
private slots:
    ...
    QString BuyGEAOU(QString OrderType, double Quantity, double Rate);
    QString SellGEAOU(QString OrderType, double Quantity, double Rate);
