...
{
    resize(900, 520);
    setWindowTitle(tr("GeaouCoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
#endif
    setObjectName("geaoucoin");
    setStyleSheet("#geaoucoin { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #dedede, stop: 1 #efefef);  }");
    // Accept D&D of URIs
    setAcceptDrops(true);
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a GeaouCoin address"));
	...
	pioAction = new QAction(QIcon(":/icons/web"), tr("&GeaouCoin Website"), this);
	pioAction->setToolTip(tr("Visit the Official GeaouCoin website"));
	bitcointalkAction = new QAction(QIcon(":/icons/bitcointalk"), tr("&Bitcointalk Discussion"), this);
	bitcointalkAction->setToolTip(tr("Visit the Bitcointalk GeaouCoin discussion thread"));
	chainAction = new QAction(QIcon(":/icons/slack"), tr("&GeaouCoin Slack"), this);
	chainAction->setToolTip(tr("Join GeaouCoin Slack"));	
	explorerAction = new QAction(QIcon(":/icons/explorer"), tr("&GeaouCoin Explorer"), this);
	explorerAction->setToolTip(tr("GeaouCoin Explorer"));	
    aboutAction = new QAction(tr("&About GeaouCoin"), this);
    aboutAction->setToolTip(tr("Show information about GeaouCoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for GeaouCoin"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("GeaouCoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("GeaouCoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GeaouCoin network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid GeaouCoin address or malformed URI parameters."));
    }
...
{
    QDesktopServices::openUrl(QUrl("https://geaoucoin.herokuapp.com"));
}
