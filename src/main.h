...
#define START_MASTERNODE_PAYMENTS_TESTNET 1511717400
#define START_MASTERNODE_PAYMENTS 1511717400
...
static const int64_t MAX_MONEY = 30000000 * COIN; // 100M PoW coins
